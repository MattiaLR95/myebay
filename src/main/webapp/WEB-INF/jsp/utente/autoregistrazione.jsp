			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="autoinsert_utente_attr" method="post" action="saveRegistrazione" novalidate="novalidate" class="row g-3">
					
							
								<div class="col-md-6">
									<label for="nome" class="form-label">Nome <span class="text-danger">*</span></label>
									<spring:bind path="nome">
										<input type="text" name="nome" id="nome" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il nome" value="${autoinsert_utente_attr.nome }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="cognome">
										<input type="text" name="cognome" id="cognome" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il cognome" value="${autoinsert_utente_attr.cognome }" required>
									</spring:bind>
								...
								<div class="col-md-6">
									...
									<spring:bind path="username">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="username" id="username" placeholder="Inserire Username" value="${autoinsert_utente_attr.username }" required>
									</spring:bind>
